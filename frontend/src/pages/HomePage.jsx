                ...
                <div className="container-medical">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold text-slate-900 mb-6 leading-tight animate-slide-up">
                            Secure, Compliant, &
                            <span className="block bg-gradient-to-r from-primary-600 via-primary-500 to-teal-400 bg-clip-text text-transparent mt-2">
                                Intelligent Healthcare
                            </span>
                        </h1>

                        {/* Subheading */}
                        <p className="text-xl md:text-2xl text-slate-600 mb-10 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s' }}>
